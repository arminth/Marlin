...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { MANUAL_FEEDRATE_XYZ, MANUAL_FEEDRATE_XYZ, MANUAL_FEEDRATE_XYZ, 120 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.27    // Unit: mm compression per 1mm/s extruder speed

...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, Ender-3, arminth)"// Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 SKR1.4 Turbo Marlin 2.0.x bugfix"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  25.48,  22.20 }
    #define DEFAULT_Ki_LIST {   2.02,   1.08 }
    #define DEFAULT_Kd_LIST { 80.25, 114.00 }
  #else
    #define DEFAULT_Kp  25.48
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 214.84
  #define DEFAULT_bedKi 42.92
  #define DEFAULT_bedKd 716.84
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 142.64 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 400, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -5, -3 }
...
#define Y_MAX_POS Y_BED_SIZE+32

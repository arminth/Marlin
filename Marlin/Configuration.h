...
#define STRING_CONFIG_H_AUTHOR "@brandstaetter, @grbd, @arminth"  // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anycubic Kossel L+ 32Bit 2208UART Ctrl_Fan Neopixel Filament Sensor LA 0.27 June 10 20 2.0.x-bugfix"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  31.37,  22.20 }
    #define DEFAULT_Ki_LIST {   2.80,   1.08 }
    #define DEFAULT_Kd_LIST { 87.83, 114.00 }
  #else
   #define DEFAULT_Kp 31.37
   #define DEFAULT_Ki 2.80
   #define DEFAULT_Kd 87.83
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from pid autotune. "M303 E-1 C8 S60" to run autotune on the bed at 60 degreesC for 8 cycles
    ...
    #define DEFAULT_bedKp 262.15
    #define DEFAULT_bedKi 49.65
    #define DEFAULT_bedKd 922.76
  #endif
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_PRINTABLE_RADIUS 117.0  // (mm)
    // Center-to-center distance of the holes in the diagonal push rods.
    #define DELTA_DIAGONAL_ROD 270        //267.49 (mm)
    ...
    #define DELTA_RADIUS 133.34          // (mm) Get this value from G33 auto calibrate
  #else
    // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  ...
  #define DELTA_ENDSTOP_ADJ { 0.0, -0.45, -0.81 } // Get these values from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.1, -0.1, 0.2  } // Get these values from G33 auto calibrate
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 582.85 }  // default steps per unit for Kossel (GT2, 20 tooth), Gregs Wayde Extruder
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 446.2 }  // default steps per unit for Kossel (GT2, 20 tooth), BMG extruder
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 600, 300 } // ...or, set your own edit limits
#endif
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 8000, 8000, 8000, 20000 } // ...or, set your own edit limits
#endif
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 5, -16.6 }
...
#define INVERT_E0_DIR true //false for Gregs Wade, true for BMG
